...
impl<'a> egui::Widget for Knob<'a> {
    fn ui(self, ui: &mut egui::Ui) -> egui::Response {
        ...
        if response.dragged() {
            ...
            *self.value =
                (*self.value - delta * range * 0.005).clamp(*self.range.start(), *self.range.end());
        ...
        painter.circle_stroke(
            center,
            radius,
            Stroke::new(1.5, Color32::from_rgb(0x55, 0x55, 0x55)),
        );
        ...
        painter.line_segment(
            [center, tip],
            Stroke::new(2.0, super::super::theme::FL_ORANGE),
        );
