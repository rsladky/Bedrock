        ...
        .show(ui, |ui| {
            ...
            for (i, ch) in project.channels.iter().enumerate() {
                ...
                painter.rect_filled(
                    Rect::from_min_size(
                        Pos2::new(origin.x, y),
                        egui::vec2(HEADER_WIDTH - 2.0, TRACK_HEIGHT - 1.0),
                    ),
                    2.0,
                    theme::BG_MID,
                );
            ...
            for track in &project.arrangement.tracks {
                ...
                let clip_color = ch
                    .map(|c| {
                        Color32::from_rgba_unmultiplied(c.color[0], c.color[1], c.color[2], 180)
                    })
                ...
                for clip in &track.clips {
                    ...
                    painter.rect_filled(
                        Rect::from_min_size(
                            Pos2::new(x, track_y + 2.0),
                            egui::vec2(w, TRACK_HEIGHT - 4.0),
                        ),
                        3.0,
                        clip_color,
                    );
                    ...
                    if rel_x >= 0.0 && rel_y >= 0.0 {
                        ...
                        if track_idx < num_tracks {
                                ...
                                .find(|t| t.channel_id == track_idx)
                            {
                                ...
                                project.arrangement.tracks.push(
                                    crate::project::arrangement::ArrangementTrack {
